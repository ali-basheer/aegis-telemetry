...
Monitors the Selective Catalytic Reduction (SCR) system for illegal shutdowns. It compares the SCR's active status against the known "Safe Operating Area" (Exhaust > 200°C) to detect "Thermal Window" cheats.
